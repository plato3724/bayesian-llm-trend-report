...
CATEGORY_DEFINITIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "default_tags": ["infrastructure", "training-infrastructure"],
    },
    {
        "id": "memory_context",
...
TAG_KEYWORDS: dict[str, list[str]] = {
    ...
    "training-infrastructure": ["training", "pretraining", "gpu", "cluster", "supercomputer", "训练", "预训练", "GPU", "集群", "超算"],
    "datacenter-networking": ["network", "networking", "rdma", "roce", "srv6", "网络", "通信", "路由", "交换机", "链路"],
    "network-protocol": ["protocol", "mrc", "multipath reliable connection", "ocp", "协议", "标准", "开放"],
    "gpu-cluster": ["gpu", "gb200", "nvidia", "amd", "intel", "英伟达", "英特尔", "GPU"],
